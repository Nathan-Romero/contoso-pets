...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "8":
            ...
            // loop through the ourAnimals array to search for matching dogs

            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    // Search combined descsriptions and report results
                    ...
                    foreach (string term in dogSearches)
                    {
                        ...
                        if (term != null && term.Trim() != "")
                        {
                            for (int j = 2; j > -1; j--)
                            {
                                // "searching" message displays a countdown
                            ...
                            // iterate through submitted characteristic terms and search the description for each term
